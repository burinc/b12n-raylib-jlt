...
![space-invaders](space-invaders.gif)
...
![penrose-tiling](penrose-tiling.gif)
...
![wireframe-shapes](wireframe-shapes.gif)
...
![spinning-cubes](spinning-cubes.gif)
...
![fourier-epicycles](fourier-epicycles.gif)
