...
A community suite of 56 raylib examples — the classic core/shapes/text demos, a
...
- ✅ [`example-catalog.md`](example-catalog.md) — a tour of all 56 examples grouped
  games / core / shapes / text / 3d, what each demonstrates, and the four-touchpoint
