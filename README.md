...
- [`docs/guide/`](docs/guide/index.md): patterns & pitfalls, each with source
  ...
  - [`example-catalog.md`](docs/guide/example-catalog.md): a tour of all 115, and the five-touchpoint recipe for adding one

- Two galleries show the same 115 recordings for different purposes. 97 are
  animated GIFs; the 18 newest examples are still frames until `bb record`
  gets to them:
